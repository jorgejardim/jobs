...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>        
        <title>
            Nível A Qualidade - <?php echo $title_for_layout; ?>
        </title>
        <?php
        echo $this->Html->meta('favicon.png', FULL_BASE_URL.$this->webroot.'favicon.png', array('type' => 'icon'))."\n";
    ...
    <body>
        <div id="container">
            ...
            <div id="footer">
                Copyright &#169; <?php echo date('Y'); ?> &#8226; Nível A Qualidade - Todos os direitos reservados.
            </div>
        </div>
