...
<?php echo $this->Form->create('QuestionsAnswer');?>
	<fieldset>
		<legend><?php __('Admin Edit'); ?> <?php __('Questions Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('QuestionsAnswer.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('QuestionsAnswer.id'))); ?></li>
