 ...
 */
        if(isset($_SERVER['HTTP_HOST'])) {
            if(($_SERVER['HTTP_HOST']=='localhost')||($_SERVER['HTTP_HOST']=='www.universidadedoingles.net')) {
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfdfhIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309257453542496749683645');
