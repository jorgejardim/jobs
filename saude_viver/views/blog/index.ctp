                        ...
                        <tr>
                            <td colspan="2" class="article_column column_separator midia" valign="top">
                                ...
                                <div class="clear">
                                    ...
                                    <div class="clear">
                                        <div class="createdate">Tuesday, 12 August 2008 22:33</div>
                                    </div>
                                </div>                                                                
                                ...
                                <div class="article-indent">
                                    <div class="clear">
                                        <table class="contentpaneopen">
                                            <tbody>
                                                <tr>
                                                    <td valign="top" colspan="2"> <p>Em Breve!</p></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
